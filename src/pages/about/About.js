  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.text}>
        <p>Meu nome é Nikolas Oliveira, eu tenho 26 anos e sou uma pessoa apaixonada por tecnologia e decidi trilhar o caminho da programação. Focado em Desenvolvimento Web. Aprendi com projetos em cursos envolvendo CRUD, APIs e banco de dados. E nos meus projetos pessoais resolvi focar nas tecnologias voltadas ao FrontEnd. <br />
